...
export interface UsageChangeSnapshot {
  ...
  tokenLimit: number;
  cost: number;
  /** Cumulative measured LLM wall-clock time (ms). */
  llmDurationMs: number;
  /** Output tokens generated by the measured LLM calls (basis for tok/s). */
...
export class UsageTracker {
  ...
  /** Cumulative wall-clock time of measured LLM calls (ms). */
  private totalLlmMs = 0;
  /** Output tokens generated by the measured LLM calls. */
  ...
  /**
   * Record one measured LLM call: its wall-clock duration and generated output tokens.
   *
   ...
   * {@link addTotal}) is excluded, keeping the rate self-consistent.
   */
