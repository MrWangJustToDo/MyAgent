...
export const createFetchUrlTool = ({ sandbox }: { sandbox: Sandbox }) => {
  return tool({
    ...
    inputExamples: [{ input: { url: "https://example.com/api/data", method: "GET" } }],
    ...
    execute: async ({ url, method, headers, body, outputPath, timeout, followRedirects }, { abortSignal }) => {
