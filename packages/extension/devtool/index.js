(function () {
  ...
  function requireIndex_production() {
    ...
    (function (exports$1) {
      ...
      var getFiberType = function (fiber) {
        ...
        (_a = fiber.hookList) === null || _a === void 0
          ...
          : _a.listToFoot(function (l) {
              ...
              if (
                l.type === HOOK_TYPE.useMemo &&
                ((_a = l.result) === null || _a === void 0 ? void 0 : _a[reactCompilerSymbol])
              ) {
                hasCompiler = true;
              }
            });
      ...
      var getMockFiberFromElement = function (element) {
        ...
        if (typeof elementType === "object" && elementType !== null) {
          ...
          switch (elementType) {
            ...
            default:
              throw new Error(
                '[@my-react/react] invalid symbol element type "'.concat(
                  elementType === null || elementType === void 0 ? void 0 : elementType.toString(),
                  '"'
                )
              );
          }
      ...
      var getTree$1 = function (fiber) {
        ...
        if (current) {
          ...
          if (dispatch && dispatch.renderMode) {
            var packageName =
              (dispatch === null || dispatch === void 0 ? void 0 : dispatch.renderPackage) || "@my-react";
      ...
      var updateFiberByHook = function (fiber, params) {
        ...
        var hookNode =
          (_c =
            (_b = (_a = fiber.hookList) === null || _a === void 0 ? void 0 : _a.toArray) === null || _b === void 0
              ? void 0
      ...
      var getHMRInternal = function (dispatch, type) {
        var _a, _b;
        return (_b =
          (_a = dispatch === null || dispatch === void 0 ? void 0 : dispatch.__dev_refresh_runtime__) === null ||
          _a === void 0
            ? void 0
      ...
      function useImperativeHandle(ref, create, inputs) {
        ...
        hookLog.push({
          ...
          stackError: new Error(),
          value:
            hook && typeof (hook === null || hook === void 0 ? void 0 : hook.value) === "object"
              ? hook.value
              : instance,
        ...
        for (var i = 0; i < readHookLog.length; i++) {
          ...
          if (displayName === null && primitiveFrame !== null) {
            displayName =
              // @ts-ignore
              parseHookName(
                primitiveFrame === null || primitiveFrame === void 0 ? void 0 : primitiveFrame.functionName
              ) ||
      ...
      function inspectHooks(renderFunction, props, currentDispatcher) {
        ...
        var rootStack =
          ancestorStackError === undefined ? [] : deduplicateFrames(ErrorStackParser.parse(ancestorStackError));
      ...
      var getHookNormal = function (fiber) {
        ...
        var processStack = function (hook, index) {
          var _a;
          var isEffect =
            hook.type === HOOK_TYPE.useEffect ||
            hook.type === HOOK_TYPE.useLayoutEffect ||
            hook.type === HOOK_TYPE.useInsertionEffect;
        ...
        (_a = hookList === null || hookList === void 0 ? void 0 : hookList.toArray()) === null || _a === void 0
          ? void 0
          : _a.forEach(processStack);
        return final;
      };
      // disable all log
          ...
          var keys =
            ((_c = nodes.map) === null || _c === void 0
              ...
              : _c.call(nodes, function (node) {
                  ...
                  var index =
                    (_a =
                      allHooksArray_1 === null || allHooksArray_1 === void 0 ? void 0 : allHooksArray_1.findIndex) ===
                      null || _a === void 0
                      ? void 0
      ...
      var getTreeMap = function () {
        return treeMap;
      };
      var getPlainStore = function () {
        return plainStore;
      };
      var getParentIdMap = function () {
        return parentIdMap;
      };
      /**
      ...
      function diffTree(snapshot, changedRoots) {
        ...
        while (stack.length) {
          ...
          if (!old) {
            ...
            var newChildren = node.c
              ? node.c.map(function (c) {
                  return c.i;
                })
              : [];
      ...
      var inspectSource = function (core) {
        ...
        if (
          ...
          core._source instanceof HTMLElement &&
          typeof globalThis["inspect"] === "function"
        ) {
          var s = core._source;
          core._source = null;
          globalThis["inspect"](s);
      ...
      var patchEvent = function (dispatch, runtime) {
        ...
        if (typeof dispatch.onFiberTrigger === "function") {
          ...
          dispatch.afterCommit = function () {
            var _a;
            (_a =
              originalAfterCommit_1 === null || originalAfterCommit_1 === void 0
                ? void 0
                : originalAfterCommit_1.call) === null || _a === void 0
              ? void 0
          ...
          dispatch.afterUpdate = function () {
            var _a;
            (_a =
              originalAfterUpdate_1 === null || originalAfterUpdate_1 === void 0
                ? void 0
                : originalAfterUpdate_1.call) === null || _a === void 0
              ? void 0
          ...
          dispatch.afterUnmount = function () {
            var _a;
            (_a =
              originalAfterUnmount_1 === null || originalAfterUnmount_1 === void 0
                ? void 0
                : originalAfterUnmount_1.call) === null || _a === void 0
              ? void 0
              : _a.call(originalAfterUnmount_1, this);
            onUnmount();
          };
        }
        (_p = globalThis.addEventListener) === null || _p === void 0
          ? void 0
          : _p.call(globalThis, "unhandledrejection", function (e) {
              return onGlobalError(e.reason);
            });
      };
      ...
      function overridePatchToFiberUnmount(dispatch, runtime) {
        if (typeof dispatch.onFiberUnmount === "function") {
          ...
          if (dispatch.onAfterCommitMount) {
            ...
            dispatch.onAfterCommit(function () {
              return runtime.notifyUnmountNode();
            });
            dispatch.onAfterUpdate(function () {
              return runtime.notifyUnmountNode();
            });
            dispatch.onAfterUnmount(function () {
              return runtime.notifyUnmountNode();
            });
          }
        } else {
      ...
      var Select = /** @class */ (function () {
        ...
        Select.prototype.inspect = function (fiber) {
          ...
          (_b = (_a = this.overlay) === null || _a === void 0 ? void 0 : _a.remove) === null || _b === void 0
            ? void 0
            : _b.call(_a);
      ...
      function groupAndSortNodes(nodeToData) {
        ...
        iterateNodes(nodeToData, function (_a) {
          ...
          (_b = positionGroups.get(key)) === null || _b === void 0
            ? void 0
            : _b.push({ rect: rect, color: color, displayName: displayName, count: count });
        });
  ...
  var onMessageFromPanelOrWorkerOrDetector = function (data) {
    ...
    if ((data === null || data === void 0 ? void 0 : data.type) === coreExports.MessagePanelType.varStore) {
      ...
      if (f) {
        ...
        core.notifyMessage(
          "success store current id: ".concat(id, " of data in the global variable: ").concat(varName),
          "success"
        );
      } else {
  ...
  var onMessage = function (message) {
    ...
    if (
      ...
      ((_a = message.data) === null || _a === void 0 ? void 0 : _a.from) !== sourceFrom.iframe
    )
      return;
    if (((_b = message.data) === null || _b === void 0 ? void 0 : _b.source) !== eventExports.DevToolSource) return;
    if (((_c = message.data) === null || _c === void 0 ? void 0 : _c.to) !== sourceFrom.hook) return;
    if (
      !detectorReady &&
      ((_d = message.data) === null || _d === void 0 ? void 0 : _d.type) === eventExports.MessageDetectorType.init
    ) {
      detectorReady = true;
      for (
        var _i = 0, pendingDetectorCallbacks_1 = pendingDetectorCallbacks;
        _i < pendingDetectorCallbacks_1.length;
        _i++
      ) {
  ...
  var onceDev = once(function () {
    hookPostMessageWithSource({
      type: eventExports.MessageHookType.mount,
      data: { mode: "develop" },
      to: sourceFrom.detector,
    });
  });
  ...
  globalHook.prepare = function () {
    ...
    if (typeof globalThis["__@my-react/react-devtool-inject-pending__"] === "function") {
      (_a = globalThis["__@my-react/react-devtool-inject-pending__"]) === null || _a === void 0
        ? void 0
        : _a.call(globalThis);
    } else {
      (_b = globalThis["__@my-react/dispatch__"]) === null || _b === void 0
        ...
        : _b.forEach(function (d) {
            var _a;
            return (_a = globalThis.__MY_REACT_DEVTOOL_RUNTIME__) === null || _a === void 0
              ? void 0
              : _a.call(globalThis, d);
          });
    }
  };
