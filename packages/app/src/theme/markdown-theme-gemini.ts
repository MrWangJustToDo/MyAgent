/**
 * Markdown theme for StreamMarkdown — aligned with the app's semantic colors.
 *
 * Usage:
 * ```tsx
 * import { markdownTheme } from "../theme/markdown-theme.js";
 * <StreamMarkdown theme={{ ...markdownTheme, width: width - 6 }}>{text}</StreamMarkdown>
 * ```
 */
...
export const markdownTheme: ThemeOptions = {
