...
How a conversation is persisted: session creation, the journal-plus-snapshot save path, listing
and loading, schema versioning, and deletion. It defines the on-disk contract that resume and the
message log build on.
## Requirements
