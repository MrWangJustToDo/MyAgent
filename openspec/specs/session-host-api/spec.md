# session-host-api Specification

## Purpose

The session handle a host is given: creation and lifecycle, how runs are driven, what state is observable, and the events a host may subscribe to.
