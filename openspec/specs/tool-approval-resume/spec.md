# tool-approval-resume Specification

## Purpose

Approval state carried across a resume: which pending approvals are restored, how they are reconciled with the durable message chain, and what the UI shows before the user decides.
