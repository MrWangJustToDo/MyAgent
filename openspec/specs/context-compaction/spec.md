...
Context compaction: how the token budget is measured, when compaction triggers and how segments are chosen, what the summary preserves, and how the compacted view is projected back onto the wire.
