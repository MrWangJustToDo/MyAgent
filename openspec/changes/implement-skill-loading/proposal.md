...
- Support configurable skill directories via agent config (default: `.agents/skills/`)
...
- Existing `.agents/skills/` directory already contains skills in compatible format
